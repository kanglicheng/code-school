	...
	var AutoComplete = React.createClass({
	  ...
	  matches: function matches() {
	    ...
	    this.props.names.forEach(function (name) {
	      var sub = name.slice(0, _this.state.inputVal.length);
	      if (sub.toLowerCase() === _this.state.inputVal.toLowerCase()) {
	        matches.push(name);
	      }
	    });
	  ...
	  render: function render() {
	    ...
	    var results = this.matches().map(function (result, i) {
	      return React.createElement(
	        'li',
	        { key: i, onClick: _this2.selectName },
	        result
	      );
	    });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	  ...
	  pollWeather: function pollWeather(location) {
	    var _this = this;
...
/***/ (function(module, exports, __webpack_require__) {
	    ...
	    var headers = this.props.panes.map(function (pane, index) {
	      ...
	      return React.createElement(
	        'span',
	        {
	          key: index,
	          className: klass,
	          onClick: _this.props.onTabChosen.bind(null, index) },
	        title,
	        ' '
	      );
	    });
	...
	var Tabs = React.createClass({
	  ...
	  selectTab: function selectTab(num) {
